...
\vspace{-15 pt}
\item SEND \textit{key message} sendet dem angegebenen Partner die Nachricht. Mit SEND \textit{key} ADD \textit{item}, wird die Liste des Partners erweitert.
\vspace{-15 pt}
